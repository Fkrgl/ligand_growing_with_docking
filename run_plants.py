...
def get_best_scoring_poses_parallel(ranking_file, plants_output, PLANTS, cutoff=0.95):
    '''
    Function retrieves pose of best model and all models with a 95% of the best models score
    '''
...
def dock_molecule_parallel(node, PLANTS):
    ...
    # get best pose as rdkit molecule with scores
    poses, score = get_best_scoring_poses_parallel(ranking_file, output_dir, PLANTS)
    return poses, score
